...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var mainModulesSLider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
    next: '.nextmodule',
    prev: '.prevmodule'
  });
  mainModulesSLider.render();
...
function () {
  ...
  _createClass(Form, [{
      ...
      form.forEach(function (form) {
        ...
        form.addEventListener('submit', function (ev) {
          ...
          _this.postData(_this.path.question, formData).then(function (res) {
            ...
            return _this.message.failure;
          }).finally(setTimeout(function () {
            _this.clearInputs(inputs);
    ...
    key: "checkMailInput",
    value: function checkMailInput(selector) {
      var mailInput = document.querySelectorAll(selector);
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockElem = this.activeBtn.closest('.module__video-item').nextElementSibling,
            copyPlay = this.activeBtn.querySelector('svg').cloneNode(true);
        ...
        if (state.data == 0) {
          if (blockElem.querySelector('.play__circle').classList.contains('closed')) {
            ...
            blockElem.querySelector('.play__circle').appendChild(copyPlay);
            blockElem.querySelector('.play__text').classList.remove('attention');
            blockElem.querySelector('.play__text').textContent = 'play vidio';
...
function () {
  ...
  _createClass(ShowInfo, [{
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        var clone = btn.querySelector('path').cloneNode(true);
        btn.addEventListener('click', function () {
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        //отображение всплывающего блока на 3 слайде
